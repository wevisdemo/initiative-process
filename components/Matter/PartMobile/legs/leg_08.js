...
export const leg_08 = (world) => {
  ...
  const elem_leg_left = elem_leg.getBoundingClientRect().left + w;
  ...
  const tri_1_ratio = device() === "mobile" ? w_mobile + 25 : w_mobile / 2 - 45;
  const tri_2_ratio = device() === "mobile" ? w_mobile + 75 : w_mobile / 2 + 25;
