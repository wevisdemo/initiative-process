...
export const leg_18 = (world) => {
  const w = 210;
  const elem_leg = document.getElementById("leg_18");
  ...
  Triangle(world, elem_leg_left - margin + 270, y - 80, -Math.PI + Math.PI / 8, 14, 2);

  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 15, 2);
  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 16, 2);
  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 17, 2);
  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 18, 2);
  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 19, 2);
  Triangle(world, elem_leg_left - margin + 315, y - 80, Math.PI - Math.PI / 5, 20, 2);
};
