...
import { y_2540, y_2550, y_2560_1, y_2560_2 } from "../../../public/data/constitution";
  ...
  return (
    <div className="absolute z-20 w-full pt-16 text-center ">
      ...
      <div className="h-full" id="leg_section_1_wrapper">
        ...
        <div className={` relative w-[600px] h-[197px] left-[-50px]  top-[700px]`} id="leg_02">
          <Image src="/images/leg_02.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[600px] h-[197px] mx-[65%] top-[700px]`} id="leg_03">
          <Image src="/images/leg_03.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[600px] h-[197px] mx-[45%] top-[700px]`} id="leg_04">
          <Image src="/images/leg_04.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[600px] h-[197px] mx-[25%] top-[700px]`} id="leg_05">
          <Image src="/images/leg_05.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[250px] h-[433px] mx-[12%] top-[700px]`} id="leg_00">
          <Image src="/images/leg_07.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[600px] h-[197px] mx-[20%] top-[700px]`} id="leg_06">
          <Image src="/images/leg_06.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[800px] h-[197px] mx-[40%] top-[700px]`} id="leg_08">
          <Image src="/images/leg_08.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[250px] h-[433px] mx-[5%] top-[500px]`} id="leg_00">
          <Image src="/images/leg_07.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[800px] h-[300px] mx-[10%] top-[500px]`} id="leg_09">
          <Image src="/images/leg_09.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[150px] h-[433px] mx-[10%] top-[300px]`} id="leg_00">
          <Image src="/images/leg_07.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[650px] h-[170px] mx-auto top-[300px]`} id="leg_10">
          <Image src="/images/leg_10.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[850px] h-[190px] mx-[45%] top-[400px]`} id="leg_11">
          <Image src="/images/leg_11.svg" layout="fill" objectFit="contain" />
        </div>
        <div className={` relative w-[280px] h-[350px] mx-[10%] top-[300px]`} id="leg_12">
